...
import (
	"github.com/SurrealGod/jelly-shop-code/pkg/jellylogger"
...
func(r *Response) Success(code int, data any) IResponse{
	r.StatusCode = code
	r.Data = data
	jellylogger.InitJellyLogger(r.Context,&r.Data).Print().Save()
	return r
}
func(r *Response) Error(code int,tractId, msg string) IResponse{
	...
	r.IsError = true
	jellylogger.InitJellyLogger(r.Context,&r.ErrorRes).Print().Save()
	return r
}
